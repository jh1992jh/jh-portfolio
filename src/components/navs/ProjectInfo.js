...
const ProjectInfo = ({ selectedTitle, selectProject, selectedProject, navOpen }) => (
    <ProjectInfoStyled>
    <Transition
     items={selectedTitle}
     from={{opacity: 0}}
        ...
        {selectedTitle => 
            ...
            <Fragment>
                ...
                <ForDesktop>
                    <GithubLink>
                        <Github />
                        <a href={`${selectedProject[0].githubRepo}`} rel="noopener noreferrer" target="_blank">
                        ...
                        <ProjectTitles>
                            ...
                            <ProjectTitle title="LandingPage" selectedTitle={selectedTitle} selectProject={selectProject}/>
                        </ProjectTitles>
            ...
            <ProjectInfoBottom>
                ...
                <a href={`${selectedProject[0].url}`} rel="noopener noreferrer"  target="_blank" >
